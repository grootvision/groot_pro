...
function gv_hub_get_items() {
	return array(
		...
		array(
			'title'         => 'تم محیط پیشخوان',
			'desc'          => 'بازطراحی کامل ظاهر پیشخوان وردپرس با ۳ تم آماده (مینیمال روشن / تیره حرفه‌ای / بنفش مدرن) + نمایش یا مخفی‌سازی گزینه‌های دلخواه از منو و نوار بالا.',
			'icon'          => '🎨',
			'page'          => GV_AT_PAGE_SLUG,
			'color'         => '#4f46e5',
			'category'      => 'design',
			'status_option' => GV_AT_OPT,
			'status_key'    => 'enabled',
		),
		array(
		...
		array(
    'title'         => 'آنالیز سئو و سرعت سایت',
    'desc'          => 'اسکن کامل سایت و گزارش دقیق مشکلات سئو (H1، تعداد کلمات، متا تگ‌ها، آدرس سئوپسند)، لینک‌های خراب و فایل‌های کند/سنگین به‌همراه نام افزونه یا قالب مقصر.',
    'icon'          => '🩺',
